        ...
        <div className="features24-image-container">
          ...
          {activeTab === 1 && (
            <img
              ...
              src={ui/src/images/Ishita_Sign.jpg}
          ...
          >
            ...
            <div className="features24-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text4">Certifications</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features24-text5">
                      Highlight your live projects with GitHub links in the
                      Projects section.
                    </span>
                  </Fragment>
                )}
          ...
          >
            ...
            <div className="features24-content2">
              <h2 className="thq-heading-2">
                {props.feature2Title ?? (
                  <Fragment>
                    <span className="features24-text6">Medium Articles</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature2Description ?? (
                  <Fragment>
                    <span className="features24-text3">
                      Display your certifications and badges in the
          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text2">About Me</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature3Description ?? (
                  <Fragment>
                    <span className="features24-text1">
                      Showcase your skills, bio, and expertise in the About Me
                      section.
                    </span>
                  </Fragment>
                )}

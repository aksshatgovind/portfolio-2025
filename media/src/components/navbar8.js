        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text18">#about</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text16">#certifications</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text21">#medium</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Read More</span>
                  </Fragment>
                )}
              </span>
            </button>
                ...
                <div className="navbar8-menu-item5">
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text22">Bio and Skills</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text14">Medium Posts</span>
                        </Fragment>
                      )}
                    </span>
                  </div>

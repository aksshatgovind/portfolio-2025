      ...
      <div className="pricing14-max-width thq-section-max-width">
        <div className="pricing14-section-title">
          <div className="pricing14-content">
            <h2 className="pricing14-text100 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="pricing14-text160">Projects</span>
                </Fragment>
              )}
            </h2>
        ...
        <div className="pricing14-tabs">
          {isMonthly && (
            ...
            >
              <span className="thq-body-small">Live</span>
            </button>
          )}
          {!isMonthly && (
            <button
          ...
          {isMonthly && (
            ...
            >
              <span className="thq-body-small">In Dev</span>
            </button>
          )}
        </div>
        {isMonthly && (
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <p className="pricing14-text106 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing14-text171">hashtag</span>
                      </Fragment>
                    )}
                  </p>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">$0/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
            ...
            <div className="pricing14-column2 thq-card">
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  <p className="pricing14-text112 thq-body-large">
                    {props.plan2 ?? (
                      <Fragment>
                        <span className="pricing14-text169">aesthene</span>
                      </Fragment>
                    )}
                  </p>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text162">$50/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing14-button15 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing14-text170">Upgrade to Pro</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column3 thq-card">
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  <p className="pricing14-text119 thq-body-large">
                    {props.plan3 ?? (
                      <Fragment>
                        <span className="pricing14-text158">FluentFriend</span>
                      </Fragment>
                    )}
                  </p>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text198">$100/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing14-button16 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text190">Get Premium</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  <span className="pricing14-text127 thq-body-large">
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text152">Basic plan</span>
                      </Fragment>
                    )}
                  </span>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  <span className="pricing14-text134 thq-body-large">
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing14-text157">Business plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing14-text135 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text155">$299/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text143 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text183">$499/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">

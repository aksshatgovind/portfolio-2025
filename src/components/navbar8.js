  ...
  return (
    <header className="navbar8-container1">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        <span className="navbar8-text10">
          {props.text ?? (
            <Fragment>
              <span className="navbar8-text16">AKSSHAT GOVIND</span>
            </Fragment>
          )}
        </span>
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text27">About</span>
                </Fragment>
              )}
            </a>
            <a
              href={props.link2Url}
              className="navbar8-link21 thq-link thq-body-small"
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text20">Certifications</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text15">Projects</span>
                </Fragment>
              )}
            </a>
            <a href={props.textUrl} className="navbar8-link10">
              {props.text1 ?? (
                <Fragment>
                  <span className="navbar8-text14">Links</span>
                </Fragment>
              )}
            </a>
          </nav>
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              <a
                href="https://drive.google.com/drive/folders/1CiQfythwpFg11FhR5_5Z2VaePQ6bwvCp?usp=sharing"
                target="_blank"
              ...
              >
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text13">Resume</span>
                  </Fragment>
                )}
              </a>
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="navbar8-mobile-menu">
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              <a
                href={props.link1Url}
                className="navbar8-link13 thq-link thq-body-small"
              >
                {props.link1 ?? (
                  <Fragment>
                    <span className="navbar8-text27">About</span>
              ...
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-link thq-body-small">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text21">Links</span>
                      </Fragment>
                    )}
                  </span>
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text17">About Me</span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text28">Projects</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
            ...
            <div className="navbar8-buttons2">
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text18">Read More</span>
                    </Fragment>
                  )}
                </span>
              </button>
                ...
                <div className="navbar8-menu-item5">
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text19">Bio and Skills</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text22">Certifications</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text26">Medium Posts</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
...
Navbar8.defaultProps = {
  ...
  page4ImageAlt: 'Medium Articles Image',
  linkUrlPage3: 'https://www.teleporthq.io',
  link2: undefined,
  link4: undefined,
  page2ImageAlt: 'Certifications Image',
